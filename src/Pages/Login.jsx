...
<Link to={'/Contacts'} className='btn btn-danger d-grid'>Login</Link>
<div className='text-center' style={{alignItems:'center'}}>
  <Link to={'/Register'} style={{textDecoration:'none',color:'black'}} className='text-center align-items-center '> <span style={{color:"blue"}}>Now user?</span> Register Now</Link>
